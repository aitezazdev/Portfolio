...
export default function Loading() {
  return (
    <section className="min-h-screen bg-[#080807] text-white px-6 md:px-48 py-10 space-y-6">
      ...
      <div className="mb-6">
        <Skeleton heig
        ht={64} width="60%" baseColor="#2c2c2c" highlightColor="#525252" />
      </div>

      <div className="mb-8 mt-10">
        <Skeleton height={20} width={100} baseColor="#2c2c2c" highlightColor="#525252" />
        <Skeleton height={16} width="80%" className="mt-2" baseColor="#2c2c2c" highlightColor="#525252" />
      </div>
      ...
      <div className="flex flex-col gap-6 mb-16">
        <Skeleton height={300} className="rounded-xl" baseColor="#2c2c2c" highlightColor="#525252" />
        <Skeleton height={300} className="rounded-xl" baseColor="#2c2c2c" highlightColor="#525252" />
      </div>
