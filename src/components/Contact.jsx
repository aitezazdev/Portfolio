...
const Contact = () => {
  ...
  return (
    <section id="contact" className="bg-[#e8e8e3] my-20">
      <div className="min-h-screen w-[93%] rounded-xl mx-auto bg-[#131211] text-[#d1d1c7] pt-5 pb-20 md:px-12 lg:px-20">
        <AnimatedHeading
          text={headingText}
          className="text-5xl md:text-7xl lg:text-8xl mt-20 mb-4"
        />

        <div className="text-lg md:text-xl opacity-80 mb-10">
          <AnimateDescription
            text={descriptionText}
            className="text-lg md:text-xl opacity-80 font-sans"
          />
        </div>
        ...
        <form className="max-w-2xl space-y-6 p-6 rounded-lg mx-auto bg-[#24231f]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-black/20 rounded-md bg-[#312f2d] resize-none focus:outline-none focus:border-black"
            />
          </div>
